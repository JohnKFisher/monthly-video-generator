...
final class MainWindowViewModel: ObservableObject {
    ...
    private func performSingleRender(outputBaseFilename: String) async {
        ...
        do {
            ...
            let preparedSession = try await prepareRenderSession(
                style: style,
                monthYear: monthYear,
                requiresSmartFrameRateInspection: exportResolution.effectiveProfile.frameRate == .smart
            )
    ...
    private func performMegaTest(combinations: [MegaTestCombination]) async {
        ...
        do {
            ...
            for (index, combination) in combinations.enumerated() {
                ...
                let exportResolution = resolveExportProfile(for: combination)
                warnings = preparedSession.preparation.warnings + exportResolution.warnings.map(\.message)
    ...
    private func resolveExportProfile(for combination: MegaTestCombination) -> ExportProfileResolution {
    ...
    private func inspectPhotoVideosForSmartFrameRateIfNeeded(
        ...
        guard requiresSmartFrameRateInspection else {
