...
- 2026-03-21: Custom opening-title text now also drives the embedded MP4 `title` metadata tag for final renders so file metadata matches the visible title card, while Plex episode identity and auto-generated filenames remain month-based.
