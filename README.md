...
- SDR exports that include HDR source videos now apply FFmpeg HDR-to-SDR tone mapping per affected video clip; HLG source videos use an HLG-tuned SDR conversion path before `BT.709` output so highlights are preserved instead of clipped.
